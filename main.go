...
const treeSleepBetwnMoves time.Duration = 500 * time.Millisecond // 500,000,000 nanoseconds
const treeSleepBetwnStrategies time.Duration = 3 * time.Second   // 3,000,000,000 nanoseconds
